...
public class TimedRunTask extends TaskTimer {
    ...
    private void handleExpiration(UUID playerUuid, TimedRunData data, HBHunt hunt, TimedBehavior behavior) {
        ...
        if (behavior != null && behavior.startPlateLocation() != null
            ...
            PaperUtil.teleportAsync(player, TimedRunManager.buildReturnLocation(behavior.startPlateLocation(), data.startYaw()));
        }
