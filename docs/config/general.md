...
- `%headblocks_leaderboard_position%`: used to get the player position in the leaderboard
- `%headblocks_leaderboard_<position>_<name|custom|value>%`: used to get the player name to build a leaderboard (
  custom => check the config file)