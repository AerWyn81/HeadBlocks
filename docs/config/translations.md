...
Messages:
  ...
  TargetBlockMoved: "%prefix% &aThe HeadBlock has been correctly moved at &e%world%&a, &e%x%&a, &e%y%&a, &e%z%"
  PluginReloading: "%prefix% &cPlease wait, the plugin is reloading..."
  TargetBlockNotHead: "%prefix% &cTargeted block is not a HeadBlock"
  OrderClickError: "%prefix% &cAnother HeadBlock need to be found before this one &7(%name%&7)"
  HitClickMax: "%prefix% &cThis HeadBlock has reached its click limit &7(%count%)"
  MeCommand:
    - ""
