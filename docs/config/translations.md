...
Messages:
  ...
  DebugUsage: "%prefix% &cThis is an advanced command. Please consult the wiki for details."
  ...
  ResyncDatabaseAlreadyInSync: "%prefix% &aDatabase is already in sync with hunt locations!"
  ResyncDatabaseFoundHeads: "%prefix% &7Found &e%count% &7head(s) in database not present in hunt locations."
  ...
  HuntDeleteConfirm: "%prefix% &cWarning: This will delete hunt &7%hunt%&c, remove its &7%headCount% &chead(s) from the world, and reset all player progress. Add &7--confirm &cto confirm."
  HuntDeleteKeepHeadsConfirm: "%prefix% &cWarning: This will delete hunt &7%hunt%&c. Its &7%headCount% &chead(s) and player progress will be moved to &7%fallback%&c. Add &7--confirm &cto confirm."
  HuntDeleteInProgress: "%prefix% &7&oDeleting hunt &e&o%hunt%&7&o, please wait..."
  HuntDeleteFallbackNotFound: "%prefix% &cFallback hunt &e%hunt% &cnot found."
  HuntDeleteFallbackRequiresKeepHeads: "%prefix% &c--fallback can only be used with --keepHeads."
  ...
  HuntAssignAllAlreadyInHunt: "%prefix% &cAll matching heads are already in hunt &e%hunt%&c."
  HuntAssignSuccess: "%prefix% &aSuccessfully assigned &e%count% &ahead(s) to hunt &e%hunt%&a. &7(%skipped% skipped)"
  ...
  TimedNotStarted: "%prefix% &cYou must step on the start plate to begin the timed run."
  TimedStarted: "%prefix% &aTimer started for hunt &e%hunt%&a! Find all the heads as fast as you can!"
  TimedRestarted: "%prefix% &eTimer restarted for hunt &e%hunt%&e! Your progression has been reset."
  TimedCompleted: "%prefix% &a&lRun complete! &aYour time: &e%time% &afor hunt &e%hunt%&a! &7(Completion #%count%)"
  TimedLeft: "%prefix% &eYou have left the timed run."
  TimedNoActiveRun: "%prefix% &cYou are not currently in a timed run."
  TimedAlreadyCompleted: "%prefix% &cYou have already completed all heads for this hunt."
...
Gui:
  ...
  TitleHuntSelection: "&8HeadBlocks &7- &e&lSelect Hunt"
  HuntSelectionItemName: "&6%huntName%"
  HuntSelectionItemLore:
    - ""
    - "&7Heads: &e%headCount%"
    - "&7State: %state%"
    - ""
    - "&a&lCLICK&8: &7Manage heads"
  ...
  RewardTypeBroadcastLore:
    ...
    - ""
    - "&a&lCLICK&8: &7Select this type"
  BehaviorSelectionTitle: "&8HeadBlocks &7- &a&lBehaviors"
  BehaviorEnabled: "&aSelected"
  BehaviorDisabled: "&7Not selected"
  ValidateCreate: "&a&lValidate"
  ValidateCreateLore:
    - ""
    - "&7Click to create the hunt"
    - "&7with the selected behaviors"
  BehaviorOrderedName: "&6Ordered"
  BehaviorOrderedLore:
    - ""
    - "&7Players must find heads"
    - "&7in a specific order"
  BehaviorScheduledName: "&bScheduled"
  BehaviorScheduledLore:
    - ""
    - "&7The hunt is only active"
    - "&7during a specific date range"
  BehaviorTimedName: "&eTimed"
  BehaviorTimedLore:
    - ""
    - "&7Players race against the clock"
    - "&7to find all heads"
  TimedActionBar: "&e&l%time% &8| &7%hunt% &8| &e%found%&7/&e%total%"
  TimedConfigTitle: "&8HeadBlocks &7- &e&lTimed Config"
  TimedConfigPlate: "&e&lStart Plate"
  TimedConfigPlateLore:
    - ""
    - "&7Current position:"
    - "%location%"
    - ""
    - "&a&lCLICK&8: &7Place a pressure plate"
  TimedConfigPlateNotDefined: "&cNot defined"
  TimedConfigPlateLocation: "&e%world% &7(%x%, %y%, %z%)"
  TimedConfigPlacePlate: "&7Place a &epressure plate &7to set the start location."
  TimedConfigPlatePlaced: "&aStart plate set! &7Reopening configuration..."
  TimedConfigRepeatable: "&6&lRepeatable"
  TimedConfigRepeatableLore:
    - ""
    - "&7When enabled, players can replay"
    - "&7the hunt after completion"
    - ""
    - "&7Status: %status%"
...
Help:
  ...
  List: "&6/hb list (huntId) <page>&8: &7&oDisplays the list of existing HeadBlocks (optionally filtered by hunt)"
  Stats: "&6/hb stats <player> (huntId) <page>&8: &7&oDisplays the list of found and missing heads for <player> (optionally filtered by hunt)"
  ...
  Leave: "&6/hb leave&8: &7&oLeave the current timed run"
```