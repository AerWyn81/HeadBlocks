...
Messages:
  ...
  ResetAllHeadConfirm: "%prefix% &cWarning, this command will reset the head &7%headName% &cfor &7%playerCount% &cplayer(s). Add &7--confirm &cin the command to confirm."
...
Gui:
  ...
  HintLore:
    ...
    - "&e&lINFO:"
    - "&7 This interface allows you to configure"
    - "&7 the activation of hint sound on the heads"
