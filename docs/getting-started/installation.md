...
If you want to use HeadBlocks in version **below 1.16**, you can use HeadBlocks version 1.6.x. Theses versions will not receive new features but will be updated to fix issues.
