    ...
    public void build() {
        if (player != null) {
            ...
            if (!isConsoleSender && command != null && size > pageHeight) {
                TextComponent c1 = new TextComponent(MessageUtils.translate(languageHandler.getMessage("Chat.PreviousPage")));
                ...
                TextComponent c2 = new TextComponent(MessageUtils.translate(languageHandler.getMessage("Chat.NextPage")));
