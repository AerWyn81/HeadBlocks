...
public class Export implements Cmd {
    ...
    public boolean perform(CommandSender sender, String[] args) {
        ...
        try {
            ...
            ps.println("-- ");
            ps.println("-- File generated by HeadBlocks " + HeadBlocks.getInstance().getDescription().getVersion() + " (" + LocalDateTime.now()
            ...
            ArrayList<String> instructions = StorageService.getInstructionsExport(typeDatabase);
